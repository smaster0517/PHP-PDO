...
<head>
	...
	if ($productCount > 0) {
		while ($row = $res->fetch()) {
    		...
    		$product_list .= "<tr><td>$id</td><td>$product_name</td><td>$date_added</td><td><a href='inventory_edit.php?pid=$id'>edit</a></td><td><a href='inventory_list.php?deleteid=$id'>delete</a></td></tr>";
		}
	}
	else {
		...
		<form id="form1" name="form1" method="post" action="inventory_list.php" class="form-horizontal" enctype="multipart/form-data">
			<div class="form-group">
			    <div class="input-group">
					...
					<input name="fr_itemname" type="text" class="form-control" id="fr_itemname" size="40" placeholder=""/>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
			    	<span class="input-group-addon">Product Price</span>
					<input name="fr_price" type="text" class="form-control" id="fr_price" size="40" placeholder="" />
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
			    	<span class="input-group-addon">Category</span>
					<input name="fr_category" type="text" class="form-control" id="fr_category" size="40" placeholder="" />
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
			    	<span class="input-group-addon">Subcategory</span>
					<input name="fr_subcategory" type="text" class="form-control" id="fr_subcategory" size="40" placeholder="" />
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
			    	<span class="input-group-addon">Product Details</span>
					<textarea name="fr_details" type="textarea" rows="4" class="form-control" id="fr_details" size="40" placeholder=""> </textarea>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
